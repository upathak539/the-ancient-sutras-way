...
const NavBar = () => {
  ...
  return (
    <>
      {menuClicked ?
        <nav className="fixed top-0 left-0 right-0  flex justify-between pb-[15px] w-[100%] bg-gradient-to-r from-amber-200 to-yellow-500  shadow-xl shadow-yellow-300 m-0 h-[185px]">
          <div className="basis-[95%] flex flex-col justify-center items-center  mt-[20px] md:basis-[50%] md:flex-row">
            <Link href='/'><Image alt='logo' src={profilePic} height={100} width={150} ></Image></Link>
            <h1 className=" mb-[10px] xs:font-Yanone md:font-Lobster text-sm font-bold bg-gradient-to-r from-pink-700 to-indigo-600 bg-clip-text text-transparent
          ...
          <div >
            ...
            <div className="md:hidden mx-[10px] basis-[5%]" >
        ...
        <section className="flex  bg-gradient-to-r from-amber-200 to-yellow-400  shadow-xl shadow-yellow-300 p-[5px] fixed top-0 left-0 right-0  h-[180px]">
          <div className="basis-[95%] flex flex-col justify-center items-center font-Lobster text-sm bg-gradient-to-r from-pink-700 to-indigo-600 bg-clip-text text-transparent font-bold">
            <Link className="mb-[10px] hover:bg-gradient-to-r from-green-700 to-green-300 bg-clip-text text-transparent cursor-pointer" onClick={() => { setmenuClicked(true) }}  href="/">Home</Link>
            <Link className="mb-[10px] hover:bg-gradient-to-r from-green-700 to-green-300 bg-clip-text text-transparent cursor-pointer" onClick={() => { setmenuClicked(true) }} href="/blogs">Blogs</Link>
            <Link className="mb-[10px] hover:bg-gradient-to-r from-green-700 to-green-300 bg-clip-text text-transparent cursor-pointer" onClick={() => { setmenuClicked(true) }} href="/videos">Videos</Link>
            <Link className="mb-[10px] hover:bg-gradient-to-r from-green-700 to-green-300 bg-clip-text text-transparent cursor-pointer" onClick={() => { setmenuClicked(true) }}  href="/subscription">Free Subscription</Link>
          </div>
          <CloseIcon  className=" basis-[5%] justify-self-end mr-[10px] " onClick={() => { setmenuClicked(true) }} />
        </section>
      }
    </>
  );
